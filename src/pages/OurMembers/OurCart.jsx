    ...
    <div className="card shadow-lg cursor-pointer mb-8">
      <div className="relative overflow-hidden rounded-t-2xl group">
        ...
        <div className="px-4 py-2 space-y-1">
          ...
          <span className="flex items-center justify-between text-gray-500 font-medium">Rating: <Rating style={{ maxWidth: 100 }} value={member.rating} readOnly /></span>
        </div>
      </div>
    </div>
  );
